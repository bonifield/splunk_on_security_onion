...
- props.conf
	- handles sourcetype and field formatting, field aliases (alternate ways to call a field), and field reporting ("send this field with this transforms.conf formatting to Splunk)
- transforms.conf
